...
package com.yugyd.quiz.gameui.gameend.model
...
import com.yugyd.quiz.domain.utils.calculatePercentageToRounded
...
class GameEndUiMapper @Inject constructor(
    ...
    fun map(
        ...
        val mappedThemeTitle = when (payload.mode) {
            Mode.ARCADE, Mode.MARATHON, Mode.TRAIN -> themeTitle
