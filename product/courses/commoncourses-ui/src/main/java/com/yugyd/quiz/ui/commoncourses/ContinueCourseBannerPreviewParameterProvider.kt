...
internal class ContinueCourseBannerPreviewParameterProvider :
    PreviewParameterProvider<List<ContinueCourseBannerUiModel>> {

    companion object {
        private const val TEST_ITEM_COUNT = 5
    }

    override val values: Sequence<List<ContinueCourseBannerUiModel>>
        get() = sequenceOf(
            buildList {
