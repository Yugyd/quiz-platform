...
import com.yugyd.quiz.themeui.section.SectionView.Action
import com.yugyd.quiz.themeui.section.SectionView.State
import com.yugyd.quiz.themeui.section.SectionView.State.NavigationState
            ...
            Surface(
                ...
                Box(
                    ...
                    val progressIcon = when (model.progressState) {
                        ProgressState.LOCKED -> painterResource(id = R.drawable.ic_lock)
                        ProgressState.EMPTY -> painterResource(id = R.drawable.ic_radio_button_unchecked)
                        ProgressState.LOW -> painterResource(id = R.drawable.ic_radio_button_checked)
                        ProgressState.MEDIUM -> painterResource(id = R.drawable.ic_radio_button_checked)
                        ProgressState.SUCCESS -> painterResource(id = R.drawable.ic_radio_button_checked)
                    }
                    Icon(
