...
internal class SelectBoolQuestPreviewParameterProvider :
    PreviewParameterProvider<SelectBoolQuestUiModel> {

    override val values: Sequence<SelectBoolQuestUiModel> = sequenceOf(createQuest())

    private fun createQuest() = SelectBoolQuestUiModel(
