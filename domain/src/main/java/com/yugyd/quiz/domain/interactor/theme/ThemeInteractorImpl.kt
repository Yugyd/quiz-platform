...
package com.yugyd.quiz.domain.interactor.theme
...
class ThemeInteractorImpl(
    ...
    override suspend fun getTheme(id: Int) = withContext(Dispatchers.IO) {
        themeSource.getTheme(id)
    }

    override suspend fun getThemes(mode: Mode): List<Theme> = withContext(Dispatchers.IO) {
