...
class OptionsInteractorImpl(private val preferencesSource: PreferencesSource) : OptionsInteractor {
    ...
    override suspend fun setTransition(value: Double) = withContext(Dispatchers.IO) {
