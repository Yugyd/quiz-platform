...
internal class SelectQuestPreviewParameterProvider :
    PreviewParameterProvider<SelectQuestUiModel> {

    override val values: Sequence<SelectQuestUiModel> = sequenceOf(createQuest())

    private fun createQuest() = SelectQuestUiModel(
